...
public class DeviceWorkflowTest extends IntegrationBase {
    ...
    public void testDeviceWentOfflineMessage() throws Exception {
        ...
        String expectedJson = new AndroidGCMMessage("token", Priority.normal, "Your My Device went offline. \"My Dashboard\" project is disconnected.", 1, getPrivateAndroidTSField(message)).toJson();

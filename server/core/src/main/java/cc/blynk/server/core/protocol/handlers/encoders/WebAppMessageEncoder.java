...
public class WebAppMessageEncoder extends ChannelOutboundHandlerAdapter {

    private static final Logger log = LogManager.getLogger(WebAppMessageEncoder.class);

...
+ Run the server on default 'hardware port 8442' and default 'application port 8443' (SSL port)
        ...
        java -jar server-0.26.2.jar -dataFolder /path
...
+ You should see something like that
        ...
        username   10539  1.0 12.1 3325808 428948 pts/76 Sl   Jan22   9:11 java -jar server-0.26.2.jar   
...
For example:
    ...
    java -jar server-0.26.2.jar -dataFolder /home/pi/Blynk -serverConfig /home/pi/someFolder/server.properties

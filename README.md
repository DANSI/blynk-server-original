...
+ Run the server on default 'hardware port 8442' and default 'application port 8443' (SSL port)
        ...
        java -jar server-0.21.6.jar -dataFolder /path
...
+ Download Blynk server jar file (or manually copy it to raspberry via ssh and scp command) : 
        ...
        wget "https://github.com/blynkkk/blynk-server/releases/download/v0.21.5/server-0.21.6.jar"

+ Run the server on default 'hardware port 8442' and default 'application port 8443' (SSL port)

        java -jar server-0.21.6.jar -dataFolder /home/pi/Blynk        
...
add the following line
        ...
        @reboot java -jar /home/pi/server-0.21.6.jar -dataFolder /home/pi/Blynk &
...
+ You will see something like that
        ...
        username   10539  1.0 12.1 3325808 428948 pts/76 Sl   Jan22   9:11 java -jar server-0.21.6.jar   
...
For example :
    ...
    java -jar server-0.21.6.jar -dataFolder /home/pi/Blynk -serverConfig /home/pi/someFolder/server.properties

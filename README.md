...
+ Run the server on default 'hardware port 8080' and default 'application port 9443' (SSL port)
        ...
        java -jar server-0.37.4.jar -dataFolder /path
...
+ Download Blynk server jar file (or manually copy it to Raspberry Pi via ssh and scp command): 
        ...
        wget "https://github.com/blynkkk/blynk-server/releases/download/v0.37.4/server-0.37.4-java8.jar"

+ Run the server on default 'hardware port 8080' and default 'application port 9443' (SSL port)

        java -jar server-0.37.4-java8.jar -dataFolder /home/pi/Blynk
...
+ To enable server auto restart find /etc/rc.local file and add:
        ...
        java -jar /home/pi/server-0.37.4.jar -dataFolder /home/pi/Blynk &
...
add the following line
        ...
        @reboot java -jar /home/pi/server-0.37.4.jar -dataFolder /home/pi/Blynk &
...
+ Put in it one line: 
        ...
        java -jar server-0.37.4.jar -dataFolder /home/pi/Blynk
...
+ You should see something like that
        ...
        username   10539  1.0 12.1 3325808 428948 pts/76 Sl   Jan22   9:11 java -jar server-0.37.4.jar   
...
For example:
    ...
    java -jar server-0.37.4.jar -dataFolder /home/pi/Blynk -serverConfig /home/pi/someFolder/server.properties
